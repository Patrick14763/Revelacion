...
// ============== GENERAR NUBES TRISTES ==============
function generarNubesTriste() {
    const container = document.querySelector(".nubes-tristes");
    ...
    // Continuar generando nubes
    setInterval(() => {
        crearNube(container);
    }, 6000);
}

function crearNube(container) {
    ...
    // Tamaño aleatorio
    const tamaño = Math.random() * 30 + 30;
    nube.style.fontSize = tamaño + "px";
    
    // Duración aleatoria
    const duracion = Math.random() * 15 + 20;
